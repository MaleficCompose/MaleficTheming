    ...
    MaterialTheme(
        colorScheme =
            ColorScheme(
                ...
                primaryFixed = themeConfig.primaryFixed,
                primaryFixedDim = themeConfig.primaryFixedDim,
                onPrimaryFixed = themeConfig.onPrimaryFixed,
                onPrimaryFixedVariant = themeConfig.onPrimaryFixedVariant,
                secondaryFixed = themeConfig.onSecondaryFixed,
                secondaryFixedDim = themeConfig.secondaryFixedDim,
                onSecondaryFixed = themeConfig.onSecondaryFixed,
                onSecondaryFixedVariant = themeConfig.onSecondaryFixedVariant,
                tertiaryFixed = themeConfig.tertiaryFixed,
                tertiaryFixedDim = themeConfig.tertiaryFixedDim,
                onTertiaryFixed = themeConfig.onTertiaryFixed,
                onTertiaryFixedVariant = themeConfig.onTertiaryFixedVariant,
            ),
